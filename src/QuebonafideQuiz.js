...
class QuebonafideQuiz extends Component {
  constructor(props){
    super(props);
  ...
  componentWillMount(){
    ...
    firebase.database().ref().child("QuebonafideQuestions").on('child_added', snap => {
      currentCards.push({
        id: snap.key,
...
export default QuebonafideQuiz;
